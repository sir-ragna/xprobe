...
class SMB {
	public:
		static const int SESS_MSG = 0x00;
		static const int SESS_REQ = 0x81;
		static const int SESS_POS_RESP = 0x82;
		static const int SESS_NEG_RESP = 0x83;
		static const int SESS_RETARGET = 0x84;
		static const int SESS_KEEPALIVE = 0x85;
		static const int NBT_NOT_LISTENING = 0x80;
		static const int NBT_NAME_NOT_PRESENT = 0x82;
		static const int NBT_SERVER_SERVICE = 0x20;
		static const int NBT_WORKSTATION_SERVICE = 0x00;
		
		static const int SMB_HDR_SIZE = 32;
		static const int SMB_OFFSET_CMD = 4;
		static const int SMB_OFFSET_NTSTATUS = 5;
		static const int SMB_OFFSET_ECLASS = 5;
		static const int SMB_OFFSET_ECODE = 7;
		static const int SMB_OFFSET_FLAGS = 9;
		static const int SMB_OFFSET_FLAGS2 = 10;
		static const int SMB_OFFSET_EXTRA = 12;
		static const int SMB_OFFSET_TID = 24;
		static const int SMB_OFFSET_PID = 26;
		static const int SMB_OFFSET_UID = 28;
		static const int SMB_OFFSET_MID = 30;
		static const int SMB_OFFSET_WC = 32;
		static const int SMB_OFFSET_COM = 33;
		static const int SMB_OFFSET_XRESERVED = 34;
		static const int SMB_OFFSET_OFFSET = 35;
		static const int SMB_OFFSET_MAXBUF = 37;
		static const int SMB_OFFSET_MPXCNT = 39;
		static const int SMB_OFFSET_VCNUM = 41;
		static const int SMB_OFFSET_SESSKEY = 43;
		static const int SMB_OFFSET_CIPASSLEN = 47;
		static const int SMB_OFFSET_CSPASSLEN = 49;
		static const int SMB_OFFSET_RESERVED = 51;
		static const int SMB_OFFSET_CAPABILITIES = 55;
		/*
		 * FLAGS
		 */
		static const int SMB_FLAGS_CANONICAL_PATHNAMES = 0x10;
		static const int SMB_FLAGS_CASELESS_PATHNAMES = 0x08;
		/*
		 * FLAGS2
		 */
		static const int SMB_FLAGS2_KNOWS_LONG_NAMES = 0x0001;
		
		/*
		 * SMB Commands
		 */
		static const int SMB_COM_NEGOTIATE = 0x72;
		static const int SMB_COM_SESS_SETUP_ANDX = 0x73;
